...
public class BracketsCellViewHolder extends RecyclerView.ViewHolder {
    ...
    public BracketsCellViewHolder(View itemView, int bracketColor, int textColor) {
        ...
        teamOneImageview = (ImageView) itemView.findViewById(R.id.team_one_IV);
        teamTwoImageview = (ImageView) itemView.findViewById(R.id.team_two_IV);
    ...
    public ImageView getTeamOneImageview() {
        return teamOneImageview;
    }

    public ImageView getTeamTwoImageview() {
        return teamTwoImageview;
    }
